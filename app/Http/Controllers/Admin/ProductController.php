...
// --------------------- add product ------------------ 
    ...
    public function storeProduct(Request $request){
        ...
        Image::make($imag_one)->resize(270,270)->save('frontend/img/product'.$name_gen);       
        ...
        Image::make($imag_two)->resize(270,270)->save('frontend/img/product'.$name_gen);       
        ...
        Image::make($imag_three)->resize(270,270)->save('frontend/img/product'.$name_gen);       
